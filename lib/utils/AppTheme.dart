...
class AppThemeData {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
      primary: LSColorPrimary,
      primaryContainer: LSColorPrimary,
      error: Colors.red,
    ),
    ...
    textTheme: TextTheme(
      labelLarge: TextStyle(color: LSColorPrimary), // button
      titleLarge: TextStyle(color: textPrimaryColor), // headline6
      titleSmall: TextStyle(color: textSecondaryColor), // subtitle2
    ),
